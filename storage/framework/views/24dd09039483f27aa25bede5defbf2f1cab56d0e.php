<?php $__env->startSection('title', 'Sửa loại công văn'); ?>
    ...
    <section class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <?php endif; ?>
                <div class="col-lg-12">
                    <form action="pages/danhmuc/loaicv/loaicv_edit/<?php echo e($loaiCv->id); ?>" method="POST">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input value="<?php echo e($loaiCv->TenLoaiCV); ?>" id="validation-pagename" class="form-control" placeholder="Loại công văn"
