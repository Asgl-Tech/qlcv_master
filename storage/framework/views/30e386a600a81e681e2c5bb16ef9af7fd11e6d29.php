<?php $__env->startSection('title', 'Edit Pages'); ?>
    ...
    <section class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <?php endif; ?>
                <div class="col-lg-12">
                    <form action="pages/danhmuc/dokhan/dokhan_edit/<?php echo e($doKhan->id); ?>" method="POST">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input value="<?php echo e($doKhan->TenDoKhan); ?>" id="validation-pagename" class="form-control" placeholder="Độ khẩn"
