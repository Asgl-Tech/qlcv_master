    ...
    <section class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <?php endif; ?>
                <div class="col-lg-12">
                    <form action="pages/danhmuc/coquan/coquan_edit/<?php echo e($coQuan->id); ?>" method="POST">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input value="<?php echo e($coQuan->TenCoQuan); ?>" id="validation-pagename" class="form-control" placeholder="Cơ quan"
