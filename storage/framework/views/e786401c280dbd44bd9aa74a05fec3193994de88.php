	...
	<div class="card-body">
        ...
        <table class="table table-hover nowrap" id="example1" width="100%">
            ...
            <tr>
               ...
               <a href="<?php echo e(route('pages.edit',$page->page_id )); ?>" class="btn btn-info btn-sm" style="margin-left:40px;"><i class="fa fa-eye"> Preview</i></a>
                    <a href="<?php echo e(route('pages.edit',$page->page_id )); ?>" class="btn btn-info btn-sm" style="margin-left:40px;"> Edit</a>
