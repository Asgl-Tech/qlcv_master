            ...
            <table class="table table-hover nowrap" id="example1" width="100%">
                ...
                <?php $__currentLoopData = $dokhan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><?php echo e($dk->TenDoKhan); ?></td>
                        <td style="width:250px;">

                            <i class="fa fa-trash fa-fw" style="margin-left:4px;margin-right:4px;"></i><a  href="pages/danhmuc/dokhan/dokhan_edit/<?php echo e($dk->id); ?>"> Sửa</a>
                            <i class="fa fa-delete  fa-fw"></i><a href="pages/danhmuc/dokhan/dokhan_del/<?php echo e($dk->id); ?>"> Xóa</a>
                        </td>
                    </tr>
