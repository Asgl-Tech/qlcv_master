        ...
        <table class="table table-hover nowrap" style="word-wrap: inherit;" id="example1" width="100%">
            ...
            <tr>
               ...
               <td style="width:250px;">
                     ...
                     <a href="pages/congvanden/preview/{{$page->id}}/{{$page->idLoaiCV}}/{{$page->NamCV}}/{{$page->idNoiPhatHanh}}/{{$page->idTheLoaiCV}}/{{$page->idLinhVuc}}/{{$page->idDoKhan}}/{{$page->idDoMat}}/{{$page->idNoiLuu}}/{{$page->NoiNhan}}" class="btn btn-primary btn-sm" ><i class="fa fa-eye" style="margin-left:6px;margin-right:6px;"></i> View</a>
