@section('title', 'Sửa danh mục Người ký')
@include('main')
    ...
    <section class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                @endif
                <div class="col-lg-12">
                    <form action="pages/danhmuc/nguoiky/nguoiky_edit/{{$nguoiky->id}}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input value="{{$nguoiky->HoTen}}" id="validation-pagename" class="form-control" placeholder="Họ tên"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="validation-pagename">Chức vụ <span
                                                style="color:red; font-weight:900; font-size:20px;">*</span></label>
                                    <input value="{{$nguoiky->ChucVu}}" id="validation-pagename" class="form-control" placeholder="Chức vụ"
