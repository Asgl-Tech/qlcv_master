    ...
    <section class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                @endif
                <div class="col-lg-12">
                    <form action="pages/danhmuc/dokhan/dokhan_edit/{{$doKhan->id}}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input value="{{$doKhan->TenDoKhan}}" id="validation-pagename" class="form-control" placeholder="Độ khẩn"
