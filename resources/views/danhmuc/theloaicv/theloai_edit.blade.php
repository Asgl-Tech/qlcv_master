@section('title', 'Sửa Thể loại công văn')
@include('main')
    ...
    <section class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                @endif
                <div class="col-lg-12">
                    <form action="pages/danhmuc/theloaicv/theloaicv_edit/{{$theloai->id}}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input value="{{$theloai->MaTheLoai}}" id="validation-pagename" class="form-control" placeholder="Loại công văn"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="validation-pagename">Tên thể loại công văn <span
                                                style="color:red; font-weight:900; font-size:20px;">*</span></label>
                                    <input value="{{$theloai->TenTheLoai}}" id="validation-pagename" class="form-control" placeholder="Loại công văn"
